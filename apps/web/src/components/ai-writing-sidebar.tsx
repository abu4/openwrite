...
export function AIWritingSidebar({ onInsertText }: AIWritingSidebarProps) {
                ...
                {messages.length === 0 && (
                  <div className="py-8 text-center">
                    ...
                    <p className="mb-4 text-muted-foreground text-sm">
                      Hi! I'm here to help with your writing. Ask me anything about characters,
                      plot, style, or storytelling.
                    </p>
